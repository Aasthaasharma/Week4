...
public class Binder {
    ...
    public String getFirstActionDate() { return firstActionDate; }
    public void setFirstActionDate(String firstActionDate) { this.firstActionDate = firstActionDate; }

    public List<Docket> getDockets() { return dockets; }
    public void setDockets(List<Docket> dockets) { this.dockets = dockets; }
